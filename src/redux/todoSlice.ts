...
export const addTodoAsync = createAsyncThunk('todos/addTodoAsync', async(payload: string) => {
    const response = await fetch('http://localhost:7000/todos', {
        method: 'POST',
        headers: {
...
export const toggleCompleteAsync = createAsyncThunk('todos/completeTodoAsync', async(payload: Todo) => {
...
export const deleteTodoAsync = createAsyncThunk('todos/deleteTodoAsync', async(payload: Todo) => {
    const response = await fetch(`http://localhost:7000/todos/${payload.id}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
